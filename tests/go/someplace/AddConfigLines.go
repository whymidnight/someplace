...
func (inst *AddConfigLines) SetBatchAccount(batch ag_solanago.PublicKey) *AddConfigLines {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(batch).WRITE()
	return inst
}

// GetBatchAccount gets the "batch" account.
func (inst *AddConfigLines) GetBatchAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetOracleAccount sets the "oracle" account.
func (inst *AddConfigLines) SetOracleAccount(oracle ag_solanago.PublicKey) *AddConfigLines {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(oracle).SIGNER()
	return inst
}

// GetOracleAccount gets the "oracle" account.
func (inst *AddConfigLines) GetOracleAccount() *ag_solanago.AccountMeta {
...
func NewAddConfigLinesInstruction(
	...
	oracle ag_solanago.PublicKey) *AddConfigLines {
