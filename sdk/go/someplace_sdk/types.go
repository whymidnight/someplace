...
func (value QuestError) String() string {
	...
	case QuestErrorSuspiciousTreasury:
		return "SuspiciousTreasury"
	case QuestErrorSuspiciousTreasuryMint:
...
func (value WhitelistMintMode) String() string {
	...
	case WhitelistMintModeNeverBurn:
		return "NeverBurn"
	case WhitelistMintModeDeferCreator:
		return "DeferCreator"
	default:
		return ""
	}
